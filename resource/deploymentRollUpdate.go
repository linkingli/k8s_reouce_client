...
func RollUpdateDeployment() {
	...
	// 读取YAML
	if deployYaml, err = ioutil.ReadFile("conf/nginx.yaml"); err != nil {
		goto FAIL
	}
	...
	if podList, err = clientset.CoreV1().Pods("default").List(v1.ListOptions{LabelSelector: "app=nginx"}); err == nil {
